...
export class KonsentrasiProdukService {
  private baseUrl = '/konsentrasi-produk-ojk'; // PERBAIKAN: Tambahkan prefix /api/v1/
   ...
   */
  private formatToFrontend(entity: KonsentrasiProdukOjkEntity | null): any[] {
  ...
  async validateConnection(): Promise<boolean> {
    try {
      const response = await api_konsentrasi_produk.get(this.baseUrl, {
        timeout: 5000,
      });
