      ...
      indicators.forEach((indicator, idx) => {
        ...
        if (transformed.mode === CalculationMode.TEKS) {
          ...
          if (transformed.isPercent) {
            hasilDisplay = roundInt(Number(transformed.hasil) * 100) + '%'; // percent dibulatkan
          } else {
            hasilDisplay = roundInt(transformed.hasil); // angka biasa dibulatkan
          }
        }

        // Format weighted — SAMA dengan PASAR & INVESTASI
