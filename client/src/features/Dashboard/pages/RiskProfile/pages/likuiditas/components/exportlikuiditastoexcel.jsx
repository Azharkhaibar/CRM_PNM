  ...
  try {
    ...
    sections.forEach((section) => {
      ...
      indicators.forEach((indicator, idx) => {
        ...
        // Format hasil display
        // Format hasil display — SAMA DENGAN INVESTASI & PASAR
        let hasilDisplay = '';
        if (transformed.mode === CalculationMode.TEKS) {
          ...
          if (transformed.isPercent) {
            hasilDisplay = Math.round(Number(transformed.hasil) * 100) + '%'; // percent → integer + %
          } else {
            hasilDisplay = Math.round(Number(transformed.hasil)); // angka biasa → integer
          }
        }
        ...
        if (transformed.mode !== CalculationMode.TEKS) {
          ...
          wsData.push([
            ...
            '',
            '',
            transformed.penyebutValue ?? '', // ⬅ NILAI tepat di bawah HASIL
            '', // Peringkat
            '', // Weighted
            '', // Aksi
          ]);
          ...
          if (transformed.mode === CalculationMode.RASIO) {
            wsData.push([
              ...
              '',
              '',
              transformed.pembilangValue ?? '', // ⬅ NILAI tepat di bawah HASIL
              '',
              '',
              '',
            ]);
