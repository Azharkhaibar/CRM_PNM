...
export declare class CreateKpmrLikuiditasOjkDto {
    year: number;
    quarter: number;
    isActive?: boolean;
    createdBy?: string;
...
export declare class UpdateKpmrLikuiditasOjkDto {
    year?: number;
    quarter?: number;
    isActive?: boolean;
    summary?: KpmrSummaryDto;
...
export declare class CreateKpmrAspekLikuiditasDto {
    nomor?: string;
    judul: string;
    bobot: number;
    deskripsi?: string;
...
export declare class UpdateKpmrAspekLikuiditasDto {
    nomor?: string;
    judul?: string;
    bobot?: number;
    deskripsi?: string;
...
export declare class CreateKpmrPertanyaanLikuiditasDto {
    nomor?: string;
    pertanyaan: string;
    skor?: KpmrSkorDto;
...
export declare class UpdateKpmrPertanyaanLikuiditasDto {
    nomor?: string;
    pertanyaan?: string;
    skor?: KpmrSkorDto;
    indicator?: KpmrIndicatorDto;
