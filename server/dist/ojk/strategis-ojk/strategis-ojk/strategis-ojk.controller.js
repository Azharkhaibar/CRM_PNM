...
const create_strategis_ojk_dto_1 = require("./dto/create-strategis-ojk.dto");
const update_strategis_ojk_dto_1 = require("./dto/update-strategis-ojk.dto");
let StrategisOjkController = class StrategisOjkController {
    strategisOjkService;
    constructor(strategisOjkService) {
        this.strategisOjkService = strategisOjkService;
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_strategis_ojk_dto_1.CreateStrategisOjkDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_strategis_ojk_dto_1.UpdateStrategisOjkDto]),
    __metadata("design:returntype", void 0)
