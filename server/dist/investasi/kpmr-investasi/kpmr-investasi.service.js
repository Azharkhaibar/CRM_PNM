...
let KPMRService = KPMRService_1 = class KPMRService {
    definitionRepo;
    scoreRepo;
    aspectRepo;
    questionRepo;
    logger = new common_1.Logger(KPMRService_1.name);
...
exports.KPMRService = KPMRService;
exports.KPMRService = KPMRService = KPMRService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(kpmr_investasi_definisi_entity_1.KPMRDefinition)),
    __param(1, (0, typeorm_1.InjectRepository)(kpmr_investasi_skor_entity_1.KPMRScore)),
    __param(2, (0, typeorm_1.InjectRepository)(kpmr_investasi_aspek_entity_1.KPMRAspect)),
    __param(3, (0, typeorm_1.InjectRepository)(kpmr_investasi_pertanyaan_entity_1.KPMRQuestion)),
