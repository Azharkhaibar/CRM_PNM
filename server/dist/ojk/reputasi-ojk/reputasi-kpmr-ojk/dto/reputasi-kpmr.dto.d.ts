...
export declare class CreateKpmrReputasiOjkDto {
    year: number;
    quarter: number;
    isActive?: boolean;
    createdBy?: string;
...
export declare class UpdateKpmrReputasiOjkDto {
    year?: number;
    quarter?: number;
    isActive?: boolean;
    summary?: KpmrSummaryDto;
...
export declare class CreateKpmrAspekReputasiDto {
    nomor?: string;
    judul: string;
    bobot: number;
    deskripsi?: string;
...
export declare class UpdateKpmrAspekReputasiDto {
    nomor?: string;
    judul?: string;
    bobot?: number;
    deskripsi?: string;
...
export declare class CreateKpmrPertanyaanReputasiDto {
    nomor?: string;
    pertanyaan: string;
    skor?: KpmrSkorDto;
...
export declare class UpdateKpmrPertanyaanReputasiDto {
    nomor?: string;
    pertanyaan?: string;
    skor?: KpmrSkorDto;
    indicator?: KpmrIndicatorDto;
