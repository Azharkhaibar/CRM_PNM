// services/operasional.api.service.ts
import axios, { AxiosError } from 'axios';

const API_BASE_URL = 'http://localhost:5530/api/v1';

export const api_operasional_produk = axios.create({
...
api_operasional_produk.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [operasional produk API] Error:', {
...
export default api_operasional_produk;
