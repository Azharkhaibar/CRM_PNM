...
@ViewEntity({
  ...
  expression: `
    ...
    SELECT 'KREDIT', kr.id, h9.year, h9.quarter, kr.parameter_id, krp.nomor, krp.judul, krp.bobot,
      kr.nomor, JSON_UNQUOTE(JSON_EXTRACT(kr.judul, '$.text')), kr.bobot, kr.sumber_risiko, kr.dampak,
...
export class RiskProfileRepositoryOjkView {
  ...
  @ViewColumn() pembilangValue: string | null;
  @ViewColumn() penyebutLabel: string | null;
  @ViewColumn() penyebutValue: string | null;
