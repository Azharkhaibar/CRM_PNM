...
let KreditProdukOjkService = KreditProdukOjkService_1 = class KreditProdukOjkService {
    ...
    async addParameter(inherentId, createParamDto, userId) {
        ...
        if (createParamDto.kategori) {
            ...
            if (kategori.model === kredit_produk_inherent_dto_1.KategoriModel.OPEN_END) {
                if (!kategori.jenis) {
            ...
            if (kategori.model === kredit_produk_inherent_dto_1.KategoriModel.TERSTRUKTUR) {
                if (kategori.jenis) {
            ...
            if (kategori.model === kredit_produk_inherent_dto_1.KategoriModel.TANPA_MODEL) {
                if (kategori.prinsip ||
                    kategori.jenis ||
        ...
        const kategoriFormatted = createParamDto.kategori
            ? {
                ...
                prinsip: createParamDto.kategori.model !== kredit_produk_inherent_dto_1.KategoriModel.TANPA_MODEL
                    ? createParamDto.kategori.prinsip
                    : undefined,
                jenis: createParamDto.kategori.model === kredit_produk_inherent_dto_1.KategoriModel.OPEN_END
                    ? createParamDto.kategori.jenis
                    : undefined,
                underlying: createParamDto.kategori.model === kredit_produk_inherent_dto_1.KategoriModel.TERSTRUKTUR
    ...
    async updateParameter(inherentId, parameterId, updateParamDto, userId) {
        ...
        if (updateParamDto.kategori) {
            ...
            parameter.kategori = {
                ...
                prinsip: kategori.model !== kredit_produk_inherent_dto_1.KategoriModel.TANPA_MODEL
                    ? kategori.prinsip
                    : undefined,
                jenis: kategori.model === kredit_produk_inherent_dto_1.KategoriModel.OPEN_END
                    ? kategori.jenis
                    : undefined,
                underlying: kategori.model === kredit_produk_inherent_dto_1.KategoriModel.TERSTRUKTUR
                    ? kategori.underlying || []
                    : [],
            };
        }
    ...
    async reorderParameters(inherentId, reorderDto) {
        ...
        try {
            for (let i = 0; i < reorderDto.parameterIds.length; i++) {
                ...
                await queryRunner.manager.update(kredit_produk_parameter_entity_1.KreditParameter, { id: parameterId, kreditProdukOjkId: inherentId }, { orderIndex: i });
            }
            await queryRunner.commitTransaction();
    ...
    async validateModelTerstruktur(inherentId) {
        ...
        const terstrukturParams = inherent.parameters?.filter((param) => param.kategori?.model === kredit_produk_inherent_dto_1.KategoriModel.TERSTRUKTUR) || [];
    ...
    async importFromExcel(importData, userId) {
        ...
        try {
            ...
            const savedInherent = await queryRunner.manager.save(kredit_produk_ojk_entity_1.KreditProdukOjk, inherent);
