    ...
    const riskDistribution = React.useMemo(() => {
        ...
        if (distribution.total > 0) {
            distribution.low.percentage = (
                (distribution.low.count / distribution.total) *
                100
            ).toFixed(2);
            distribution.lowToModerate.percentage = (
                (distribution.lowToModerate.count / distribution.total) *
                100
            ).toFixed(2);
            distribution.moderate.percentage = (
                (distribution.moderate.count / distribution.total) *
                100
            ).toFixed(2);
            distribution.moderateToHigh.percentage = (
                (distribution.moderateToHigh.count / distribution.total) *
                100
            ).toFixed(2);
            distribution.high.percentage = (
                (distribution.high.count / distribution.total) *
                100
            ).toFixed(2);
        }
                    ...
                    <tbody>
                        {groups.length === 0 ? (
                            <tr>
                                <td
                                    colSpan={18}
                                    className="px-3 py-6 text-center text-gray-500 border border-gray-400"
                                >
                                        ...
                                        {g.items.map((r, idx) => {
                                            ...
                                            const raw =
                                                r.hasil === "" || r.hasil == null
                                                    ? null
                                                    : Number(String(r.hasil).replace(/,/g, ""));
                                            ...
                                            const numVal =
                                                r.numeratorValue === "" || r.numeratorValue == null
                                                    ? ""
                                                    : fmtNumber(r.numeratorValue);
                                            const denVal =
                                                r.denominatorValue === "" || r.denominatorValue == null
                                                    ? ""
                                                    : fmtNumber(r.denominatorValue);

                                            return (
                                                <React.Fragment
                                                    key={`${g.no}-${g.sectionLabel}-${r.subNo}-${idx}`}
                                                >
                                                    ...
                                                    <tr className="align-top hover:bg-gray-50">
                                                        {isFirstOfSection && (
                                                            <>
                                                                <td
                                                                    ...
                                                                    className="border border-gray-400 px-3 py-2 bg-[#d9eefb]"
                                                                >
                                                                    {g.no}
                                                                </td>
                                                                <td
                                                        ...
                                                        <td className="border border-gray-400 px-3 py-2 bg-[#d9eefb] text-center">
                                                            {r.subNo}
                                                        </td>

                                                        <td
                                                            className="border border-gray-400 px-3 py-2 bg-[#d9eefb] align-top"
                                                        ...
                                                        <td className="border border-gray-400 px-3 py-2 text-center bg-[#d9eefb]">
                                                            {String(r.bobotIndikator)}%
                                                        </td>

                                                        <td
                                                            className="border border-gray-400 px-3 py-2 align-top bg-[#d9eefb]"
                                                        ...
                                                        <td className="border border-gray-400 px-2 py-2 text-center text-xs bg-green-700/10">
                                                            {r.low}
                                                        </td>
                                                        <td className="border border-gray-400 px-2 py-2 text-center text-xs bg-green-700/10">
                                                            {r.lowToModerate}
                                                        ...
                                                        <td className="border border-gray-400 px-3 py-2 text-right bg-gray-400/20">
                                                            {hasilDisplay}
                                                        </td>
                                                        ...
                                                        <td className="border border-gray-400 px-3 py-2">
                                                            <div className="flex gap-1">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="inline-flex items-center gap-1 px-2 py-1 rounded-lg border hover:bg-red-50 text-red-600"
                                                                >
                                                    ...
                                                    {mode !== "NILAI_TUNGGAL" && (
                                                        <tr>
                                                            ...
                                                            <td className="border border-gray-300 px-3 py-2"></td>
                                                            <td className="border border-gray-300 px-3 py-2"></td>
                                                            <td className="border border-gray-300 px-3 py-2 bg-[#c6d9a7] text-right">
                                                                {numVal}
                                                            </td>
                                                            <td className="border border-gray-300 px-3 py-2"></td>
                                                            <td className="border border-gray-300 px-3 py-2"></td>
