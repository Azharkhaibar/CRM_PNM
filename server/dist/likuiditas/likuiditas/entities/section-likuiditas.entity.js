...
const likuiditas_entity_2 = require("./likuiditas.entity");
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: likuiditas_entity_1.Quarter }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => likuiditas_entity_2.Likuiditas, (likuiditas) => likuiditas.section),
