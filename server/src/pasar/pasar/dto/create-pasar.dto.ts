// src/features/Dashboard/pages/RiskProfile/pages/Pasar/dto/create-pasar.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
import { CalculationMode, Quarter } from '../entities/pasar.entity';

export class CreatePasarDto {
