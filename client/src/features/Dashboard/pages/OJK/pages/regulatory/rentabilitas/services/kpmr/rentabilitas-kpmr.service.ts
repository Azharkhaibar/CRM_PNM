...
class KpmrRentabilitasApiService {
  ...
  async createAspek(kpmrId: number | string, data: CreateKpmrAspekRentabilitasDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_rentabilitas_produk.post(url, payload);
  ...
  async updateAspek(id: number | string, data: UpdateKpmrAspekRentabilitasDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_rentabilitas_produk.patch(url, data);
  ...
  async deleteAspek(id: number | string): Promise<void> {
    try {
      ...
      await api_rentabilitas_produk.delete(url);
    } catch (error: any) {
  ...
  async updatePertanyaan(id: number | string, data: UpdateKpmrPertanyaanRentabilitasDto): Promise<FrontendPertanyaanResponse> {
    try {
      ...
      const response = await api_rentabilitas_produk.patch(url, payload);
