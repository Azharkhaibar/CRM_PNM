...
import { exportPasarToExcel } from './exportExcel';

/**
 * Export Risiko Pasar ke Excel dengan layout Investasi,
 * tapi merge No/Bobot/Section per Section (bisa multi indikator).
 */
export function exportKPMRPasarToExcel({ year, quarter, sectionNo, sectionLabel, bobotSection, rows }) {
  ...
  return exportPasarToExcel(mapped, year, quarter, {
