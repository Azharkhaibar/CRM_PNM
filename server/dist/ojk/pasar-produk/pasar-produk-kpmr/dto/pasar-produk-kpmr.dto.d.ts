...
export declare class CreateKpmrPasarOjkDto {
    year: number;
    quarter: number;
    isActive?: boolean;
    createdBy?: string;
...
export declare class UpdateKpmrPasarOjkDto {
    year?: number;
    quarter?: number;
    isActive?: boolean;
    summary?: KpmrSummaryDto;
...
export declare class CreateKpmrAspekPasarDto {
    nomor?: string;
    judul: string;
    bobot: number;
    deskripsi?: string;
...
export declare class UpdateKpmrAspekPasarDto {
    nomor?: string;
    judul?: string;
    bobot?: number;
    deskripsi?: string;
...
export declare class CreateKpmrPertanyaanPasarDto {
    nomor?: string;
    pertanyaan: string;
    skor?: KpmrSkorDto;
...
export declare class UpdateKpmrPertanyaanPasarDto {
    nomor?: string;
    pertanyaan?: string;
    skor?: KpmrSkorDto;
    indicator?: KpmrIndicatorDto;
