// src/features/Dashboard/pages/RiskProfile/pages/tabs/kpmr-operational-tab.jsx
...
export default function KPMROperationalTab({ viewYear, setViewYear, viewQuarter, setViewQuarter, query, setQuery }) {
  // -------------------- KPMR OPERASIONAL --------------------
    ...
    <div className="space-y-6">
      ...
      <section className={`rounded-2xl border shadow p-4 ${PNM_BRAND.gradient} text-white`}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold drop-shadow">Form KPMR – Operasional</h2>
        ...
        <div className="flex justify-end gap-2 mt-4">
          {KPMR_editingIndex === null ? (
            <button onClick={KPMR_addRow} className="bg-white/90 text-gray-900 font-semibold px-5 py-2 rounded-lg shadow mt-2">
              Simpan
            </button>
          ) : (
