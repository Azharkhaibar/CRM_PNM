...
import StratejikTab from './tabs/stratejiktab';
import KPMRStratejikTab from './tabs/kpmrstratejiktab';
    ...
    <div className="p-6 bg-[#f3f6f8] min-h-screen">
      ...
      <div className={`relative rounded-2xl overflow-hidden mb-6 shadow-sm ${PNM_BRAND.gradient}`}>
        ...
        <div className="relative px-6 py-7 sm:px-8 sm:py-8">
          ...
          <p className="mt-1 text-white/90 text-sm">Form Stratejik &amp; KPMR dalam 1 halaman.</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-md p-6">{activeTab === 'stratejik' ? <StratejikTab /> : <KPMRStratejikTab />}</div>
    </div>
  );
}
