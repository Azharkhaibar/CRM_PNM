      ...
      <div className="bg-white rounded-lg w-full max-w-md p-6 shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center pt-2 border-t border-gray-100">
                  ...
                  <span className="capitalize font-semibold text-gray-900 text-sm">
                    : {itemType}
                  </span>
                </div>
              </div>
        ...
        <div className="flex justify-end gap-3 mt-6">
          <Button
            onClick={onCancel}
            disabled={isLoading}
            className="px-4 py-2.5 border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {cancelText}
          </Button>
          <Button
            onClick={onConfirm}
            disabled={isLoading}
            className="px-4 py-2.5 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isLoading ? (
              <>
