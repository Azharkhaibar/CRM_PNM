// src/features/Dashboard/pages/RiskProfile/pages/Operasional/dto/create-operasional-section.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
export class CreateOperasionalSectionDto {
  @ApiProperty({
    example: '7.1',
