...
// Buat instance axios untuk investasi
export const api_likuiditas = axios.create({
...
api_likuiditas.interceptors.response.use(
  (response) => response,
  (error: AxiosError) => {
    console.error('❌ [INVESTASI API] Error:', {
