 ...
 * }} options
 */
export function exportInvestasiToExcel(
    filteredRows,
    viewYear,
    viewQuarter,
    options = {}
    ...
    const {
        sheetName = `${viewYear}-${viewQuarter}`,
        filePrefix = "FORM-INVESTASI",
    ...
    sorted.forEach((r) => {
        const weightedVal =
            r.weighted === "" || r.weighted == null ? "" : Number(r.weighted);
