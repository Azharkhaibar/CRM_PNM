...
export default function StrategisProdukInherentWrapper() {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Strategis Regulatory untuk periode ini? Semua parameter dan nilai akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapApiService.undoClonePeriodData({
        ...
        categories: ['strategis-regulatory'],
      });
      await backendHandlers.refreshData();
