...
export default function RentabilitasProdukInherentWrapper() {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Rentabilitas Regulatory untuk periode ini? Semua parameter dan nilai akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapApiService.undoClonePeriodData({
        ...
        categories: ['rentabilitas-regulatory'],
      });
      await backendHandlers.refreshData();
