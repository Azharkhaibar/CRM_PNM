...
import { exportTindakLanjut } from '../utils/export-excel';
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              {!isEditing ? (
                ...
                <div className="flex gap-2">
                  <button type="button" onClick={() => setIsEditing(false)} className="px-4 py-2 bg-gray-100 text-gray-600 rounded-lg font-semibold hover:bg-gray-200 text-sm">
                    Batal
                  </button>
                  <button type="submit" className="flex items-center gap-2 px-5 py-2 bg-green-600 text-white rounded-lg font-bold hover:bg-green-700 transition-all shadow-md text-sm">
              ...
              <div className={`p-5 rounded-xl border transition-colors ${isEditing ? 'bg-blue-50/50 border-blue-200' : 'bg-gray-50 border-gray-200'}`}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      disabled={!isEditing}
                      className="w-full border border-gray-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100 disabled:text-gray-500 resize-none"
                      rows={3}
                      value={formData.korektifOwner}
                      onChange={(e) => setFormData({ ...formData, korektifOwner: e.target.value })}
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, antisipasiOwner: e.target.value })}
              ...
              <div className={`p-5 rounded-xl border transition-colors ${isEditing ? 'bg-green-50/50 border-green-200' : 'bg-gray-50 border-gray-200'}`}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <textarea
                      disabled={!isEditing}
                      className="w-full border border-gray-300 rounded-lg p-3 text-sm focus:ring-2 focus:ring-green-500 disabled:bg-gray-100 disabled:text-gray-500 resize-none"
                      rows={3}
                      value={formData.korektifSupport}
                      onChange={(e) => setFormData({ ...formData, korektifSupport: e.target.value })}
                    />
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-gray-500 mb-1.5">Tindakan Antisipasi</label>
                    <textarea
                      ...
                      onChange={(e) => setFormData({ ...formData, antisipasiSupport: e.target.value })}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-gray-100">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, statusKorektifOwner: e.target.value })}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, targetKorektifOwner: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, statusAntisipasiOwner: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                >
                  <option value="On Progress">On Progress</option>
                  <option value="Done">Done</option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, targetAntisipasiOwner: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, statusKorektifSupport: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                >
                  <option value="On Progress">On Progress</option>
                  <option value="Done">Done</option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, targetKorektifSupport: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setFormData({ ...formData, statusAntisipasiSupport: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                >
                  <option value="On Progress">On Progress</option>
                  <option value="Done">Done</option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, targetAntisipasiSupport: e.target.value })}
                  className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm disabled:bg-gray-100"
                />
              </div>
            </div>
