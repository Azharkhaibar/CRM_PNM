...
CREATE OR REPLACE VIEW risk_profile_repository_ojk_view AS
    ...
    SELECT 'LIKUIDITAS', l.id, h2.year, h2.quarter, l.parameter_id, lp.nomor, lp.judul, lp.bobot,
      l.nomor, JSON_UNQUOTE(JSON_EXTRACT(l.judul, '$.text')), l.bobot, l.sumber_risiko, l.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(l.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(l.judul, '$.valuePembilang'), JSON_EXTRACT(l.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(l.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(l.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, l.keterangan, COALESCE(h2.is_locked, FALSE), l.created_at, l.updated_at, lp.judul, NULL
    ...
    SELECT 'OPERASIONAL', o.id, h3.year, h3.quarter, o.parameter_id, op.nomor, op.judul, op.bobot,
      o.nomor, JSON_UNQUOTE(JSON_EXTRACT(o.judul, '$.text')), o.bobot, o.sumber_risiko, o.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(o.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(o.judul, '$.valuePembilang'), JSON_EXTRACT(o.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(o.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(o.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, o.keterangan, COALESCE(h3.is_locked, FALSE), o.created_at, o.updated_at, op.judul, NULL
    ...
    SELECT 'HUKUM', h.id, h4.year, h4.quarter, h.parameter_id, hp.nomor, hp.judul, hp.bobot,
      h.nomor, JSON_UNQUOTE(JSON_EXTRACT(h.judul, '$.text')), h.bobot, h.sumber_risiko, h.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(h.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(h.judul, '$.valuePembilang'), JSON_EXTRACT(h.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(h.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(h.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, h.keterangan, COALESCE(h4.is_locked, FALSE), h.created_at, h.updated_at, hp.judul, NULL
    ...
    SELECT 'STRATEGIK', s.id, h5.year, h5.quarter, s.parameter_id, sp.nomor, sp.judul, sp.bobot,
      s.nomor, JSON_UNQUOTE(JSON_EXTRACT(s.judul, '$.text')), s.bobot, s.sumber_risiko, s.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(s.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(s.judul, '$.valuePembilang'), JSON_EXTRACT(s.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(s.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(s.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, s.keterangan, COALESCE(h5.is_locked, FALSE), s.created_at, s.updated_at, sp.judul, NULL
    ...
    SELECT 'KEPATUHAN', k.id, h6.year, h6.quarter, k.parameter_id, kp.nomor, kp.judul, kp.bobot,
      k.nomor, JSON_UNQUOTE(JSON_EXTRACT(k.judul, '$.text')), k.bobot, k.sumber_risiko, k.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(k.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(k.judul, '$.valuePembilang'), JSON_EXTRACT(k.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(k.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(k.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, k.keterangan, COALESCE(h6.is_locked, FALSE), k.created_at, k.updated_at, kp.judul, NULL
    ...
    SELECT 'REPUTASI', r.id, h7.year, h7.quarter, r.parameter_id, rp.nomor, rp.judul, rp.bobot,
      r.nomor, JSON_UNQUOTE(JSON_EXTRACT(r.judul, '$.text')), r.bobot, r.sumber_risiko, r.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(r.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(r.judul, '$.valuePembilang'), JSON_EXTRACT(r.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(r.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(r.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, r.keterangan, COALESCE(h7.is_locked, FALSE), r.created_at, r.updated_at, rp.judul, NULL
    ...
    SELECT 'KONSENTRASI', ko.id, h8.year, h8.quarter, ko.parameter_id, kop.nomor, kop.judul, kop.bobot,
      ko.nomor, JSON_UNQUOTE(JSON_EXTRACT(ko.judul, '$.text')), ko.bobot, ko.sumber_risiko, ko.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(ko.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(ko.judul, '$.valuePembilang'), JSON_EXTRACT(ko.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(ko.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(ko.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, ko.keterangan, COALESCE(h8.is_locked, FALSE), ko.created_at, ko.updated_at, kop.judul, NULL
    ...
    SELECT 'KREDIT', kr.id, h9.year, h9.quarter, kr.parameter_id, krp.nomor, krp.judul, krp.bobot,
      kr.nomor, JSON_UNQUOTE(JSON_EXTRACT(kr.judul, '$.text')) AS "indikator", kr.bobot, kr.sumber_risiko, kr.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(kr.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(kr.judul, '$.valuePembilang'), JSON_EXTRACT(kr.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(kr.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(kr.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, kr.keterangan, COALESCE(h9.is_locked, FALSE), kr.created_at, kr.updated_at, krp.judul, NULL
    ...
    SELECT 'PERMODALAN', pm.id, h10.year, h10.quarter, pm.parameter_id, pmp.nomor, pmp.judul, pmp.bobot,
      pm.nomor, JSON_UNQUOTE(JSON_EXTRACT(pm.judul, '$.text')), pm.bobot, pm.sumber_risiko, pm.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(pm.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(pm.judul, '$.valuePembilang'), JSON_EXTRACT(pm.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(pm.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(pm.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, pm.keterangan, COALESCE(h10.is_locked, FALSE), pm.created_at, pm.updated_at, pmp.judul, NULL
    ...
    SELECT 'RENTABILITAS', rb.id, h11.year, h11.quarter, rb.parameter_id, rbp.nomor, rbp.judul, rbp.bobot,
      rb.nomor, JSON_UNQUOTE(JSON_EXTRACT(rb.judul, '$.text')), rb.bobot, rb.sumber_risiko, rb.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(rb.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(rb.judul, '$.valuePembilang'), JSON_EXTRACT(rb.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(rb.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(rb.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, rb.keterangan, COALESCE(h11.is_locked, FALSE), rb.created_at, rb.updated_at, rbp.judul, NULL
    ...
    SELECT 'TATAKELOLA', t.id, h12.year, h12.quarter, t.parameter_id, tp.nomor, tp.judul, tp.bobot,
      t.nomor, JSON_UNQUOTE(JSON_EXTRACT(t.judul, '$.text')), t.bobot, t.sumber_risiko, t.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(t.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(t.judul, '$.valuePembilang'), JSON_EXTRACT(t.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(t.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(t.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, t.keterangan, COALESCE(h12.is_locked, FALSE), t.created_at, t.updated_at, tp.judul, NULL
    ...
    SELECT 'INVESTASI', i.id, h13.year, h13.quarter, i.parameter_id, ip.nomor, ip.judul, ip.bobot,
      i.nomor, JSON_UNQUOTE(JSON_EXTRACT(i.judul, '$.text')), i.bobot, i.sumber_risiko, i.dampak,
      ...
      JSON_UNQUOTE(JSON_EXTRACT(i.judul, '$.pembilang')), 
      JSON_UNQUOTE(COALESCE(JSON_EXTRACT(i.judul, '$.valuePembilang'), JSON_EXTRACT(i.judul, '$.value'))),
      JSON_UNQUOTE(JSON_EXTRACT(i.judul, '$.penyebut')), 
      JSON_UNQUOTE(JSON_EXTRACT(i.judul, '$.valuePenyebut')),
      NULL, NULL, 0, 0, i.keterangan, COALESCE(h13.is_locked, FALSE), i.created_at, i.updated_at, ip.judul, NULL
...
console.log('Recreating view in database...');
connection.query(sql, (err, results) => {
  if (err) {
    console.error('Error recreating view:', err);
    process.exit(1);
  } else {
    console.log('View successfully recreated!');
  }
  connection.end();
});
