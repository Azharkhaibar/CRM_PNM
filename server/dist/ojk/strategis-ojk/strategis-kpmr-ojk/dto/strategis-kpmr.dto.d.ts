...
export declare class CreateKpmrStrategisOjkDto {
    year: number;
    quarter: number;
    isActive?: boolean;
    createdBy?: string;
...
export declare class UpdateKpmrStrategisOjkDto {
    year?: number;
    quarter?: number;
    isActive?: boolean;
    summary?: KpmrSummaryDto;
...
export declare class CreateKpmrAspekStrategisDto {
    nomor?: string;
    judul: string;
    bobot: number;
    deskripsi?: string;
...
export declare class UpdateKpmrAspekStrategisDto {
    nomor?: string;
    judul?: string;
    bobot?: number;
    deskripsi?: string;
...
export declare class CreateKpmrPertanyaanStrategisDto {
    nomor?: string;
    pertanyaan: string;
    skor?: KpmrSkorDto;
...
export declare class UpdateKpmrPertanyaanStrategisDto {
    nomor?: string;
    pertanyaan?: string;
    skor?: KpmrSkorDto;
    indicator?: KpmrIndicatorDto;
