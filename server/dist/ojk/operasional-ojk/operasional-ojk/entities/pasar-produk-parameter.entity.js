...
__decorate([
    (0, typeorm_1.ManyToOne)(() => PasarProdukOjk, (pasar) => pasar.parameters, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'pasar_produk_ojk_id' }),
    __metadata("design:type", typeof (_a = typeof PasarProdukOjk !== "undefined" && PasarProdukOjk) === "function" ? _a : Object)
], PasarParameter.prototype, "pasarProdukOjk", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => operasional_produk_nilai_entity_1.PasarNilai, (nilai) => nilai.parameter, {
        cascade: true,
    }),
