...
export default function KepatuhanInherent({ viewYear, viewQuarter, onViewYearChange, onViewQuarterChange, query, onQueryChange }) {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Kepatuhan untuk periode ini? Semua indikator dan section akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapDataAPI.resetPeriodData(viewYear, viewQuarter, 'KEPATUHAN');
