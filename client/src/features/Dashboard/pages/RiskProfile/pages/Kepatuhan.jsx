      ...
      indicators: [
        {
          ...
          subNo: "7.1.1",
          indikator:
            "Nominal sanksi denda kewajiban membayar yang dikenakan kepada Perusahaan dari otoritas",
          bobotIndikator: 50,
          sumberRisiko:
            "Perusahaan tidak mengikuti perubahan kebijakan/regulasi terbaru, Kelalaian dalam pelaporan atau prosedur administratif",
          dampak:
            "Pengeluaran tak terduga untuk membayar denda, potensi penalti tambahan (bunga, biaya keterlambatan)",
      ...
      >
        ...
        <div className="relative px-6 py-7 sm:px-8 sm:py-8">
          ...
          <p className="mt-1 text-white/90 text-sm">
            Form Kepatuhan & KPMR dalam 1 halaman.
          </p>
        </div>
      </div>
      ...
      <div className="mb-6 border-b border-gray-200">
        <nav className="flex space-x-8">
          <button
            ...
            className={`py-3 px-1 border-b-2 font-medium text-sm transition-colors ${activeTab === "hukum"
                        ...
                        {filteredSections.length === 0 ? (
                          ...
                          filteredSections.map((s) => {
                            ...
                            const sectionRowSpan = inds.reduce(
                              (sum, it) => sum + (it.mode === "TEKS" ? 1 : rowsPerIndicator),
                              0
                            );
                              ...
                              <React.Fragment key={s.id}>
                                {inds.map((it, idx) => {
                                  ...
                                  if (it.mode === "TEKS") {
                                    ...
                                    if (it.isPercent) {
                                      hasilDisplay = (Number(it.hasil) * 100).toFixed(2) + "%";
                                    } else {
                                      hasilDisplay = Number(it.hasil).toFixed(4);
                                    }
                                  }
