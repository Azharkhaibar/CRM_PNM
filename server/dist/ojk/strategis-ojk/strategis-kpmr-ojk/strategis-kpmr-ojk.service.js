...
var KpmrStrategisService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.KpmrStrategisService = void 0;
...
let KpmrStrategisService = KpmrStrategisService_1 = class KpmrStrategisService {
    kpmrRepository;
    aspekRepository;
    pertanyaanRepository;
    dataSource;
    logger = new common_1.Logger(KpmrStrategisService_1.name);
    MAX_BOBOT_TOTAL = 100;
    ...
    async reorderRemainingAspek(kpmrId) {
        ...
        await this.dataSource.transaction(async (manager) => {
            for (let i = 0; i < aspekList.length; i++) {
                await manager.update(strategis_kpmr_aspek_entity_1.KpmrAspekStrategis, aspekList[i].id, {
                    orderIndex: i,
                });
            }
        });
    ...
    async reorderRemainingPertanyaan(aspekId) {
        ...
        await this.dataSource.transaction(async (manager) => {
            for (let i = 0; i < pertanyaanList.length; i++) {
                await manager.update(strategis_kpmr_pertanyaan_entity_1.KpmrPertanyaanStrategis, pertanyaanList[i].id, {
                    orderIndex: i,
                });
            }
        });
    ...
    convertToFrontendFormat(kpmr) {
        ...
        return (0, class_transformer_1.plainToInstance)(strategis_kpmr_dto_1.FrontendKpmrResponseDto, frontendKpmr);
    }
    ...
    async updateAspek(id, updateDto, updatedBy) {
        ...
        try {
            ...
            return (0, class_transformer_1.plainToInstance)(strategis_kpmr_dto_1.FrontendAspekResponseDto, {
        ...
        try {
            await this.dataSource.transaction(async (manager) => {
                for (let i = 0; i < reorderDto.aspekIds.length; i++) {
                    await manager.update(strategis_kpmr_aspek_entity_1.KpmrAspekStrategis, reorderDto.aspekIds[i], {
                        orderIndex: i,
                    });
                }
            });
    ...
    async updatePertanyaan(id, updateDto) {
        ...
        this.checkKpmrLocked(pertanyaan.aspek.kpmrStrategis, 'mengupdate pertanyaan');
        if (updateDto.skor) {
        ...
        try {
            ...
            return (0, class_transformer_1.plainToInstance)(strategis_kpmr_dto_1.FrontendPertanyaanResponseDto, {
        ...
        try {
            for (const update of bulkDto.updates) {
                const pertanyaan = await queryRunner.manager
                    .getRepository(strategis_kpmr_pertanyaan_entity_1.KpmrPertanyaanStrategis)
                    .findOne({
    ...
    async deletePertanyaan(id) {
        ...
        const pertanyaan = await this.getPertanyaanWithRelations(id);
        this.checkKpmrLocked(pertanyaan.aspek.kpmrStrategis, 'menghapus pertanyaan');
        try {
        ...
        try {
            await this.dataSource.transaction(async (manager) => {
                for (let i = 0; i < reorderDto.pertanyaanIds.length; i++) {
                    await manager.update(strategis_kpmr_pertanyaan_entity_1.KpmrPertanyaanStrategis, reorderDto.pertanyaanIds[i], {
                        orderIndex: i,
                    });
                }
            });
    ...
    async findAllAspek(kpmrId) {
        ...
        return aspekList.map((aspek) => (0, class_transformer_1.plainToInstance)(strategis_kpmr_dto_1.FrontendAspekResponseDto, {
            id: aspek.id.toString(),
            nomor: aspek.nomor || '',
            judul: aspek.judul,
            bobot: aspek.bobot.toString(),
...
exports.KpmrStrategisService = KpmrStrategisService;
exports.KpmrStrategisService = KpmrStrategisService = KpmrStrategisService_1 = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(strategis_kpmr_ojk_entity_1.KpmrStrategisOjk)),
    __param(1, (0, typeorm_1.InjectRepository)(strategis_kpmr_aspek_entity_1.KpmrAspekStrategis)),
    __param(2, (0, typeorm_1.InjectRepository)(strategis_kpmr_pertanyaan_entity_1.KpmrPertanyaanStrategis)),
    __metadata("design:paramtypes", [typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.Repository,
        typeorm_2.DataSource])
], KpmrStrategisService);
