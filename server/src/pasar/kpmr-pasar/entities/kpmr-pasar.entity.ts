// src/kpmr-pasar/entities/kpmr-pasar.entity.ts
import {
  Entity,
...
@Entity('kpmr_pasar')
export class KpmrPasar {
  @PrimaryGeneratedColumn()
  id_kpmr_pasar: number;

  // Periode - konsisten dengan investasi
  @Column({ type: 'int' })
  year: number;
  ...
  // Aspek Information - konsisten dengan investasi
  ...
  // Section Information - konsisten dengan investasi
  ...
  // Level Descriptions - menggunakan nama yang sama dengan investasi
  ...
  // Evidence - konsisten dengan investasi
  @Column({ type: 'text', nullable: true })
  evidence?: string;
