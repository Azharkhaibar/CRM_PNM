...
import { RISK_ATTITUDE_INFO, UNIT_TYPES, MONTH_OPTIONS, DEFAULT_RISK_CATEGORIES } from '../utils/rasContants';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-white/20 mt-8">
                <button type="button" onClick={onCancel} className="px-6 py-3 bg-white/10 text-white rounded-xl font-semibold hover:bg-white/20 transition-all">
                  Batal
                </button>
                <button
                  type="submit"
                  className={`px-8 py-3 rounded-xl text-white font-bold shadow-lg transition-all ${initialData ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600' : 'bg-gradient-to-r from-blue-600 to-indigo-700 hover:from-blue-700'}`}
                >
