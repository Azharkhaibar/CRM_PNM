          ...
          <table className="min-w-max text-sm table-fixed">
            <thead>
              <tr>
                ...
                <th className="border border-black px-2 py-2 bg-blue-900 text-white w-10">No</th>
                <th className="border border-black px-2 py-2 bg-blue-900 text-white w-64">ID Indikator</th>
                <th className="border border-black px-2 py-2 bg-blue-900 text-white w-16">Bobot</th>
                <th className="border border-black px-2 py-2 bg-blue-900 text-white w-64">Kode Emiten</th>
                <th className="border border-black px-2 py-2 bg-blue-900 text-white w-64">% kepemilikan</th>
                    ...
                    rows.push(
                      <tr key={`${param.id}-${nilai.id}-${subIndex}`}>
                        ...
                        <td className={`border px-2 py-2 text-center ${isMainRow ? 'bg-[#E8F5FA]' : 'bg-white'} break-words max-w-[180px]`}>
                          {isMainRow ? nilai.kodeEmiten ?? "-" : ""}
                        </td>

                        <td className={`border px-2 py-2 text-center ${isMainRow ? 'bg-[#E8F5FA]' : 'bg-white'} break-words max-w-[180px]`}>
                          {isMainRow ? nilai.kepemilikan ?? "-" : ""}
                        </td>
