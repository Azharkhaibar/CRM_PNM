...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // Refresh notifications untuk mendapatkan notifikasi login terbaru
      setTimeout(async () => {
        try {
      ...
      setDialogMessage('✅ Login berhasil! Selamat datang di RIMS 👋');
      setShowDialog(true);
      ...
      setTimeout(() => {
        ...
        nvg('/dashboard', {
          state: {
            fromLogin: true,
            welcomeMessage: `Selamat datang, ${userID}!`,
          },
        });
      }, 2000);
    } catch (err) {
