                ...
                return (
                  <React.Fragment key={gi}>
                    {g.items.map((r, idx) => {
                      ...
                      // Label untuk pembilang dan penyebut
                      ...
                      return (
                        <React.Fragment key={`${g.no}-${g.sectionLabel}-${r.subNo}-${idx}`}>
                          <tr className={isInherited(r) ? 'bg-yellow-50/50' : ''}>
                            ...
                            <td className="border px-3 py-0 align-top bg-[#d9eefb]">
                              <div className="custom-scrollbar" style={{ minHeight: 70, padding: '12px 0' }}>
                                {r.sumberRisiko}
                              </div>
                            </td>
                            <td className="border px-3 py-0 align-top bg-[#d9eefb]">
                             ...
                             <td className="border px-3 py-0 text-center">
                              <div className="custom-scrollbar" style={{ minHeight: 70, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4px' }}>
                                {r.low}
                              </div>
                            </td>
                            <td className="border px-3 py-0 text-center">
