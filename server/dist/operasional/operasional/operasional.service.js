...
let OperasionalService = class OperasionalService {
    operasionalSectionRepository;
    operasionalRepository;
    constructor(operasionalSectionRepository, operasionalRepository) {
        this.operasionalSectionRepository = operasionalSectionRepository;
    ...
    async deleteSection(id) {
        ...
        await this.operasionalSectionRepository.save(section);
        return {
            success: true,
    ...
    async deleteIndikator(id) {
        ...
        await this.operasionalRepository.save(indikator);
        return {
            success: true,
    ...
    validateModeSpecificFields(dto) {
        const mode = dto.mode;
        if (mode === operasional_entity_1.CalculationMode.RASIO) {
        ...
        else if (mode === operasional_entity_1.CalculationMode.NILAI_TUNGGAL) {
            if (dto.penyebutValue !== undefined && dto.penyebutValue < 0) {
                throw new common_1.BadRequestException('Nilai penyebut tidak boleh negatif untuk mode NILAI_TUNGGAL');
            }
        }
        else if (mode === operasional_entity_1.CalculationMode.TEKS) {
...
exports.OperasionalService = OperasionalService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(operasional_section_entity_1.OperasionalSection)),
    __param(1, (0, typeorm_1.InjectRepository)(operasional_entity_1.Operasional)),
