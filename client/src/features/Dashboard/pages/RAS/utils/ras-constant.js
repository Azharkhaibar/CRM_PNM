export const RISK_ATTITUDE_INFO = [
  {
    label: 'Tidak Toleran',
    color: 'red',
    desc: ['Sangat berhati-hati dalam mengambil Risiko dan lebih memilih menjaga stabilitas dan konsistensi dalam operasi bisnis;', 'konsistensi dalam operasi bisnis;', 'Keputusan bisnis didasarkan pada pemeliharaan modal.'],
  },
  {
    label: 'Konservatif',
    color: 'yellow',
...
export const DEFAULT_RISK_CATEGORIES = ['Investasi', 'Pasar', 'Likuiditas', 'Operasional', 'Hukum', 'Stratejik', 'Kepatuhan', 'Reputasi'];
