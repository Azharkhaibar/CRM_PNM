// PERUBAHAN: Ganti semua "Hukum" menjadi "Kepatuhan"
// PERUBAHAN: Ganti "transformIndicatorToFrontendHukum" menjadi "transformIndicatorToFrontendKepatuhan"
// PERUBAHAN: Ganti "exportHukumToExcel" menjadi "exportKepatuhanToExcel"
// PERUBAHAN: Ganti "LAPORAN RISIKO HUKUM BANK" menjadi "LAPORAN RISIKO KEPATUHAN BANK"
// PERUBAHAN: Ganti nama sheet 'Data Hukum' menjadi 'Data Kepatuhan'
...
const transformIndicatorToFrontendKepatuhan = (indikator = {}) => ({
  id: indikator.id,
  ...
  try {
    ...
    sections.forEach((section) => {
      ...
      indicators.forEach((indicator, idx) => {
        ...
        const transformed = transformIndicatorToFrontendKepatuhan(indicator); // ⬅️ PERUBAHAN
        ...
        if (transformed.mode === CalculationMode.TEKS) {
          ...
          if (transformed.isPercent) {
            hasilDisplay = Math.round(Number(transformed.hasil) * 100) + '%'; // percent → int %
          } else {
            hasilDisplay = Math.round(Number(transformed.hasil)); // angka → int
          }
        }

        // Format weighted display — SAMA DENGAN INVESTASI & PASAR
    ...
    // ===================== SHEET RINGKASAN =====================
    // PERUBAHAN: Judul menjadi 'LAPORAN RISIKO KEPATUHAN BANK'
    ...
    // ===== SIMPAN KE FILE =====
    // PERUBAHAN: Nama sheet menjadi 'Data Kepatuhan'
