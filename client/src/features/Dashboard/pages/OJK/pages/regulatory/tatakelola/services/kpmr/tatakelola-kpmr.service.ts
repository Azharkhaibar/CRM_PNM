...
class KpmrTataKelolaApiService {
  ...
  async createAspek(kpmrId: number | string, data: CreateKpmrAspekTataKelolaDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_tatakelola_produk.post(url, payload);
  ...
  async updateAspek(id: number | string, data: UpdateKpmrAspekTataKelolaDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_tatakelola_produk.patch(url, data);
  ...
  async deleteAspek(id: number | string): Promise<void> {
    try {
      ...
      await api_tatakelola_produk.delete(url);
    } catch (error: any) {
  ...
  async updatePertanyaan(id: number | string, data: UpdateKpmrPertanyaanTataKelolaDto): Promise<FrontendPertanyaanResponse> {
    try {
      ...
      const response = await api_tatakelola_produk.patch(url, payload);
