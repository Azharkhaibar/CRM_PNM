...
export default function HukumInherentWrapper() {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Hukum Regulatory untuk periode ini? Semua parameter dan nilai akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapApiService.undoClonePeriodData({
