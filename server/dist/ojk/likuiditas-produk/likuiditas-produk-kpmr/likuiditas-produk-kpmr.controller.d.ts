...
import { CreateKpmrLikuiditasOjkDto, CreateKpmrAspekLikuiditasDto, CreateKpmrPertanyaanLikuiditasDto, UpdateKpmrAspekLikuiditasDto, UpdateKpmrLikuiditasOjkDto, UpdateKpmrPertanyaanLikuiditasDto, UpdateSkorDto, UpdateSummaryDto, BulkUpdateSkorDto, ReorderAspekDto, ReorderPertanyaanDto, FrontendAspekResponseDto, FrontendKpmrResponseDto, FrontendPertanyaanResponseDto } from './dto/likuiditas-kpmr.dto';
export declare class KpmrLikuiditasController {
    private readonly kpmrService;
    constructor(kpmrService: KpmrLikuiditasService);
    create(createDto: CreateKpmrLikuiditasOjkDto, req: any): Promise<FrontendKpmrResponseDto>;
    ...
    update(id: string, updateDto: UpdateKpmrLikuiditasOjkDto): Promise<FrontendKpmrResponseDto>;
    ...
    createAspek(kpmrId: string, createDto: CreateKpmrAspekLikuiditasDto): Promise<FrontendAspekResponseDto>;
    updateAspek(id: string, updateDto: UpdateKpmrAspekLikuiditasDto): Promise<FrontendAspekResponseDto>;
    removeAspek(id: string): Promise<void>;
    reorderAspek(kpmrId: string, reorderDto: ReorderAspekDto): Promise<void>;
    createPertanyaan(aspekId: string, createDto: CreateKpmrPertanyaanLikuiditasDto): Promise<FrontendPertanyaanResponseDto>;
    updatePertanyaan(id: string, updateDto: UpdateKpmrPertanyaanLikuiditasDto): Promise<FrontendPertanyaanResponseDto>;
