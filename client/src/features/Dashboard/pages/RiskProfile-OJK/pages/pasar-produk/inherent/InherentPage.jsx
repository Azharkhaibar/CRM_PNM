            ...
            <>
              ...
              <div className="w-full text-slate-800">
                ...
                <Input
                  ...
                  onChange={(e) => 
                    isEditModeForComponents
                      ? handleChangeDraftNilai("portofolio", e.target.value)
                      : handleChangeNilaiField("portofolio", e.target.value)
                  }
                  disabled={isFieldDisabled()}
          ...
          <table className="text-sm table-auto w-full">
            ...
            <thead>
              <tr>
                ...
                <th className="border border-black px-2 py-2 bg-blue-900 text-white text-center">Bobot</th>
                <th className="border border-black px-2 py-2 bg-blue-900 text-white text-center">% dalam Portofolio</th>
                    ...
                    <tr key={key}>
                      ...
                      {isMainRow ? (
                        <>
                          ...
                          <td className="border border-black px-2 py-2 max-w-[150px] text-center bg-[#E8F5FA] break-words">
                            {nilai.portofolio ?? "-"}
                          </td>
                        </>
                      ) : (
