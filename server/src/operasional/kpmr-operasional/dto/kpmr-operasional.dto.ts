// src/features/Dashboard/pages/RiskProfile/pages/Operasional/dto/kpmr-operasional.dto.ts
import {
  IsNotEmpty,
  IsString,
  IsNumber,
...
// ============================================================================
export class CreateKPMROperasionalAspectDto {
...
export class UpdateKPMROperasionalAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Operasional' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
export class CreateKPMROperasionalQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
  ...
  @ApiProperty({
    example:
      'Bagaimana perumusan tingkat risiko operasional yang akan diambil?',
...
export class UpdateKPMROperasionalQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
export class CreateKPMROperasionalDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMROperasionalDefinitionDto {
...
// ============================================================================
export class CreateKPMROperasionalScoreDto {
...
export class UpdateKPMROperasionalScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)
