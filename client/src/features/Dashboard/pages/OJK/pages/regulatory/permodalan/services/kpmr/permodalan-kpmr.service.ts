...
class KpmrPermodalanApiService {
  ...
  async createAspek(kpmrId: number | string, data: CreateKpmrAspekPermodalanDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_permodalan_produk.post(url, payload);
  ...
  async updateAspek(id: number | string, data: UpdateKpmrAspekPermodalanDto): Promise<FrontendAspekResponse> {
    try {
      ...
      const response = await api_permodalan_produk.patch(url, data);
  ...
  async deleteAspek(id: number | string): Promise<void> {
    try {
      ...
      await api_permodalan_produk.delete(url);
    } catch (error: any) {
  ...
  async updatePertanyaan(id: number | string, data: UpdateKpmrPertanyaanPermodalanDto): Promise<FrontendPertanyaanResponse> {
    try {
      ...
      const response = await api_permodalan_produk.patch(url, payload);
