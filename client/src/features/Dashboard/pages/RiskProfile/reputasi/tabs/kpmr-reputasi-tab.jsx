...
import { exportKPMRInvestasiToExcel } from '../../pages/investasi/utils/investasi/exportexcelkpmrinvest';
...
const KPMR_EMPTY_FORM = {
  ...
  aspekBobot: 30,
  sectionNo: '1',
  sectionTitle: 'Bagaimana perumusan tingkat risiko yang akan diambil (risk appetite) dan toleransi risiko (risk tolerance) terkait risiko reputasi?',
  sectionSkor: '',
  level1: '',
  level2: '',
  level3: '',
...
export default function KPMRReputasiTab() {
    ...
    <div className="space-y-6">
      ...
      <section className={`rounded-2xl border shadow p-4 ${PNM_BRAND.gradient} text-white`}>
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-semibold drop-shadow">Form KPMR – Reputasi</h2>
