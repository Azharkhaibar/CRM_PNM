...
// ============================================================================
// KPMR LIKUIDITAS ASPECT DTO (Master Aspek)
// ============================================================================
export class CreateKPMRLikuiditasAspectDto {
...
export class UpdateKPMRLikuiditasAspectDto {
  ...
  @ApiPropertyOptional({ example: 'Tata Kelola Risiko Likuiditas' })
  @IsOptional()
  @IsString()
  @Length(1, 255)
  aspekTitle?: string;
...
// ============================================================================
// KPMR LIKUIDITAS QUESTION DTO (Master Pertanyaan)
// ============================================================================
export class CreateKPMRLikuiditasQuestionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
  @IsInt({ message: 'Tahun harus berupa angka' })
  @Type(() => Number)
...
export class UpdateKPMRLikuiditasQuestionDto {
  @ApiPropertyOptional({ example: 'Aspek 1' })
  @IsOptional()
  @IsString()
  @Length(1, 50)
...
// ============================================================================
// KPMR LIKUIDITAS DEFINITION DTO (Year-Level)
// ============================================================================
export class CreateKPMRLikuiditasDefinitionDto {
  @ApiProperty({ example: 2024, description: 'Tahun data' })
  @IsNotEmpty({ message: 'Tahun tidak boleh kosong' })
...
export class UpdateKPMRLikuiditasDefinitionDto {
...
// ============================================================================
// KPMR LIKUIDITAS SCORE DTO (Quarter-Level)
// ============================================================================
export class CreateKPMRLikuiditasScoreDto {
...
export class UpdateKPMRLikuiditasScoreDto {
  @ApiPropertyOptional()
  @IsOptional()
  @IsInt()
  @Type(() => Number)
