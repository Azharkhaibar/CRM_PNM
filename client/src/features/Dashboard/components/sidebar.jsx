...
import logo from '../../../assets/logo_pnm.png';
  ...
  return (
    <div className="bg-white w-64 h-screen border-r p-4 flex flex-col">
      <div className="flex justify-center mb-6">
        <img src={logo} alt="PNM" className="w-32 object-contain" />
      </div>
        ...
        <ul className="space-y-1">
          ...
          <li>
            <button
              ...
              className={`w-full text-left block py-2 px-4 rounded-lg text-[18px] font-medium transition
            ...
            {openRisk && (
              <ul className="ml-4 mt-2 space-y-1 border-l pl-3 border-gray-300">
                {riskItems.map((item) => {
