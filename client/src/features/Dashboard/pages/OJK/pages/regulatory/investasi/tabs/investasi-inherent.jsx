...
export default function InvestasiProdukInherentWrapper() {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Investasi Regulatory untuk periode ini? Semua parameter dan nilai akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapApiService.undoClonePeriodData({
        ...
        categories: ['investasi-regulatory'],
      });
      await backendHandlers.refreshData();
