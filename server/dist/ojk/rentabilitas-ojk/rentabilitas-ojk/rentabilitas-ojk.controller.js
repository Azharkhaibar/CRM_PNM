...
exports.RentabilitasProdukOjkController = void 0;
const common_1 = require("@nestjs/common");
const swagger_1 = require("@nestjs/swagger");
const rentabilitas_ojk_service_1 = require("./rentabilitas-ojk.service");
const rentabilitas_inherent_dto_1 = require("./dto/rentabilitas-inherent.dto");
let RentabilitasProdukOjkController = class RentabilitasProdukOjkController {
    inherentService;
...
exports.RentabilitasProdukOjkController = RentabilitasProdukOjkController;
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({
        summary: 'Get all Rentabilitas Produk OJK data or by year/quarter',
    }),
...
], RentabilitasProdukOjkController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('active'),
    (0, swagger_1.ApiOperation)({ summary: 'Get active Rentabilitas Produk OJK data' }),
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "getActive", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get Rentabilitas Produk OJK by ID' }),
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create new Rentabilitas Produk OJK data' }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.CreateRentabilitasInherentDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Data created successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [rentabilitas_inherent_dto_1.CreateRentabilitasInherentDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "create", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update Rentabilitas Produk OJK data' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.UpdateRentabilitasInherentDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, rentabilitas_inherent_dto_1.UpdateRentabilitasInherentDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "update", null);
__decorate([
    (0, common_1.Put)(':id/summary'),
    (0, swagger_1.ApiOperation)({ summary: 'Update summary only' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.UpdateSummaryDto }),
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, rentabilitas_inherent_dto_1.UpdateSummaryDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "updateSummary", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "updateActiveStatus", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete Rentabilitas Produk OJK data' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "remove", null);
__decorate([
    (0, common_1.Get)(':id/parameters'),
    (0, swagger_1.ApiOperation)({
        summary: 'Get all parameters for specific Rentabilitas Produk OJK',
    }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "getParameters", null);
__decorate([
    (0, common_1.Post)(':id/parameters'),
    (0, swagger_1.ApiOperation)({ summary: 'Add new parameter' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.CreateParameterDto }),
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, rentabilitas_inherent_dto_1.CreateParameterDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "addParameter", null);
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.UpdateParameterDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, rentabilitas_inherent_dto_1.UpdateParameterDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "updateParameter", null);
__decorate([
    (0, common_1.Put)(':id/parameters/reorder'),
    (0, swagger_1.ApiOperation)({ summary: 'Reorder parameters' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.ReorderParametersDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, rentabilitas_inherent_dto_1.ReorderParametersDto]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "reorderParameters", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "copyParameter", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "removeParameter", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "getNilai", null);
__decorate([
    (0, common_1.Post)(':id/parameters/:parameterId/nilai'),
    (0, swagger_1.ApiOperation)({ summary: 'Add new nilai' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiParam)({ name: 'parameterId', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.CreateNilaiDto }),
    ...
    __param(3, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, rentabilitas_inherent_dto_1.CreateNilaiDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "addNilai", null);
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.UpdateNilaiDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Number, rentabilitas_inherent_dto_1.UpdateNilaiDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "updateNilai", null);
__decorate([
    (0, common_1.Put)(':id/parameters/:parameterId/nilai/reorder'),
    (0, swagger_1.ApiOperation)({ summary: 'Reorder nilai' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiParam)({ name: 'parameterId', type: Number }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.ReorderNilaiDto }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Nilai reordered successfully' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('parameterId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, rentabilitas_inherent_dto_1.ReorderNilaiDto]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "reorderNilai", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "copyNilai", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number, Number, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "removeNilai", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "exportToExcel", null);
__decorate([
    (0, common_1.Post)('import'),
    (0, swagger_1.ApiOperation)({ summary: 'Import data from Excel format' }),
    (0, swagger_1.ApiBody)({ type: rentabilitas_inherent_dto_1.ImportExportDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Import successful' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [rentabilitas_inherent_dto_1.ImportExportDto, Object]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "importFromExcel", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "getReferences", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], RentabilitasProdukOjkController.prototype, "checkExists", null);
exports.RentabilitasProdukOjkController = RentabilitasProdukOjkController = __decorate([
    (0, swagger_1.ApiTags)('Rentabilitas Produk OJK'),
    (0, common_1.Controller)('rentabilitas-produk-ojk'),
    ...
    __metadata("design:paramtypes", [rentabilitas_ojk_service_1.RentabilitasProdukOjkService])
], RentabilitasProdukOjkController);
