...
export default function ReputasiInherent({ viewYear, viewQuarter, onViewYearChange, onViewQuarterChange, query, onQueryChange }) {
  ...
  const handleResetData = async () => {
    if (!confirm('Apakah Anda yakin ingin menghapus/reset semua data Reputasi untuk periode ini? Semua indikator dan section akan terhapus secara permanen.')) {
      return;
    }
    try {
      await rekapDataAPI.resetPeriodData(viewYear, viewQuarter, 'REPUTASI');
