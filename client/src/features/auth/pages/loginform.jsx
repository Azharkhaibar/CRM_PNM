        ...
        >
          <div className="text-center mb-8">
            <img
              src={fileIMG}
              alt="PNM Logo"
              className="mx-auto w-64 h-auto drop-shadow-lg transition-opacity duration-300"
            />
            <h1 className={`text-3xl font-semibold mt-4 transition-colors duration-300 ${darkMode ? 'text-white' : 'text-gray-800'}`}>
              Selamat Datang
            </h1>
          ...
          <form onSubmit={handleLogin}>
            ...
            {error && (
              <motion.p
                ...
                className={`text-sm text-center mt-2 transition-colors duration-300 ${darkMode ? 'text-red-400' : 'text-red-500'}`}
              >
                {error}
              </motion.p>
            )}
          ...
          <motion.div
            ...
            className={`mt-6 p-3 rounded-lg text-xs text-center ${darkMode ? 'bg-blue-900/30 text-blue-300' : 'bg-blue-100 text-blue-700'}`}
          >
      ...
      >
        <div
          className={`absolute inset-0 transition-all duration-300 ${
            darkMode ? 'bg-gradient-to-t from-black/60 to-transparent' : 'bg-gradient-to-t from-black/40 to-transparent'
          }`}
        />
      </div>
      <AnimatePresence>
