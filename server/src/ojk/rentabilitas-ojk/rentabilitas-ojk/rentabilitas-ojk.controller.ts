// src/ojk/rentabilitas-produk/rentabilitas-produk-ojk/rentabilitas-produk-ojk.controller.ts
import {
  Controller,
  Get,
  Post,
...
@ApiTags('Rentabilitas Produk OJK')
@Controller('rentabilitas-produk-ojk')
...
export class RentabilitasProdukOjkController {
  constructor(private readonly inherentService: RentabilitasProdukOjkService) {}
  ...
  @Get('active')
  @ApiOperation({ summary: 'Get active Rentabilitas Produk OJK data' })
  @ApiResponse({
    status: 200,
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get Rentabilitas Produk OJK by ID' })
  ...
  @Post()
  @ApiOperation({ summary: 'Create new Rentabilitas Produk OJK data' })
  @ApiBody({ type: CreateRentabilitasInherentDto })
  @ApiResponse({ status: 201, description: 'Data created successfully' })
  @ApiResponse({ status: 400, description: 'Bad request' })
  async create(
    @Body() createDto: CreateRentabilitasInherentDto,
    @Request() req,
  ) {
  ...
  @Put(':id')
  @ApiOperation({ summary: 'Update Rentabilitas Produk OJK data' })
  @ApiParam({ name: 'id', type: Number })
  @ApiBody({ type: UpdateRentabilitasInherentDto })
  @ApiResponse({ status: 200, description: 'Data updated successfully' })
  @ApiResponse({ status: 404, description: 'Data not found' })
  async update(
    @Param('id', ParseIntPipe) id: number,
    @Body() updateDto: UpdateRentabilitasInherentDto,
    @Request() req,
  ) {
    const userId = req.user?.id || 'system';
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Delete Rentabilitas Produk OJK data' })
  @ApiParam({ name: 'id', type: Number })
