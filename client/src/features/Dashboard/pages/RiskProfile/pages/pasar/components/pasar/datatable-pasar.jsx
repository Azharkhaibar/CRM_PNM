...
export default function DataTablePasar({ rows, totalWeighted, viewYear, viewQuarter, startEdit, removeRow }) {
  const filtered = rows || [];
                    ...
                    return (
                      <React.Fragment key={`${g.no}-${g.sectionLabel}-${r.subNo}-${idx}`}>
                        <tr className={isInherited(r) ? 'bg-yellow-50/50' : ''}>
                          ...
                          <td className="relative" style={{ padding: 0, margin: 0 }}>
