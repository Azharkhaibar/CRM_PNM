...
export default function HukumRegulatory() {
  ...
  const handleExportToExcel = useCallback(async () => {
    if (activeTab === "inherent") {
      await exportInherentToExcel({
        ...
        year,
        quarter: activeQuarter,
        categoryLabel: "Hukum Regulatory",
      });
  ...
  return (
    <div className="w-full space-y-4">
      <Header title="Risk Profile – Hukum" onExportClick={handleExportToExcel} showQuarterActions={true}/>
