...
exports.KreditProdukOjkController = void 0;
...
], KreditProdukOjkController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)('active'),
    (0, swagger_1.ApiOperation)({ summary: 'Get active Kredit Produk OJK data' }),
    ...
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "getActive", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get Kredit Produk OJK by ID' }),
    ...
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.UpdateSummaryDto }),
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, kredit_produk_inherent_dto_1.UpdateSummaryDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "updateSummary", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "updateActiveStatus", null);
__decorate([
    (0, common_1.Delete)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Delete Kredit Produk OJK data' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "remove", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "getParameters", null);
__decorate([
    (0, common_1.Post)(':id/parameters'),
    (0, swagger_1.ApiOperation)({ summary: 'Add new parameter' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.CreateParameterDto }),
    ...
    __param(2, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, kredit_produk_inherent_dto_1.CreateParameterDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "addParameter", null);
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.UpdateParameterDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, kredit_produk_inherent_dto_1.UpdateParameterDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "updateParameter", null);
__decorate([
    (0, common_1.Put)(':id/parameters/reorder'),
    (0, swagger_1.ApiOperation)({ summary: 'Reorder parameters' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.ReorderParametersDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
    ...
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, kredit_produk_inherent_dto_1.ReorderParametersDto]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "reorderParameters", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "copyParameter", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "removeParameter", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "getNilai", null);
__decorate([
    (0, common_1.Post)(':id/parameters/:parameterId/nilai'),
    (0, swagger_1.ApiOperation)({ summary: 'Add new nilai' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiParam)({ name: 'parameterId', type: Number }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.CreateNilaiDto }),
    ...
    __param(3, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, kredit_produk_inherent_dto_1.CreateNilaiDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "addNilai", null);
__decorate([
    ...
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.UpdateNilaiDto }),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, Number, kredit_produk_inherent_dto_1.UpdateNilaiDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "updateNilai", null);
__decorate([
    (0, common_1.Put)(':id/parameters/:parameterId/nilai/reorder'),
    (0, swagger_1.ApiOperation)({ summary: 'Reorder nilai' }),
    (0, swagger_1.ApiParam)({ name: 'id', type: Number }),
    (0, swagger_1.ApiParam)({ name: 'parameterId', type: Number }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.ReorderNilaiDto }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Nilai reordered successfully' }),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Param)('parameterId', common_1.ParseIntPipe)),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number, kredit_produk_inherent_dto_1.ReorderNilaiDto]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "reorderNilai", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "copyNilai", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number, Number, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "removeNilai", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "exportToExcel", null);
__decorate([
    (0, common_1.Post)('import'),
    (0, swagger_1.ApiOperation)({ summary: 'Import data from Excel format' }),
    (0, swagger_1.ApiBody)({ type: kredit_produk_inherent_dto_1.ImportExportDto }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Import successful' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [kredit_produk_inherent_dto_1.ImportExportDto, Object]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "importFromExcel", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", Promise)
], KreditProdukOjkController.prototype, "checkExists", null);
exports.KreditProdukOjkController = KreditProdukOjkController = __decorate([
    (0, swagger_1.ApiTags)('Kredit Produk OJK'),
    (0, common_1.Controller)('kredit-produk-ojk'),
    ...
    __metadata("design:paramtypes", [kredit_produk_ojk_service_1.KreditProdukOjkService])
], KreditProdukOjkController);
//# sourceMappingURL=kredit-produk-ojk.controller.js.map