...
export declare class CreateKpmrOperasionalOjkDto {
    year: number;
    quarter: number;
    isActive?: boolean;
    createdBy?: string;
...
export declare class UpdateKpmrOperasionalOjkDto {
    year?: number;
    quarter?: number;
    isActive?: boolean;
    summary?: KpmrSummaryDto;
...
export declare class CreateKpmrAspekOperasionalDto {
    nomor?: string;
    judul: string;
    bobot: number;
    deskripsi?: string;
...
export declare class UpdateKpmrAspekOperasionalDto {
    nomor?: string;
    judul?: string;
    bobot?: number;
    deskripsi?: string;
...
export declare class CreateKpmrPertanyaanOperasionalDto {
    nomor?: string;
    pertanyaan: string;
    skor?: KpmrSkorDto;
...
export declare class UpdateKpmrPertanyaanOperasionalDto {
    nomor?: string;
    pertanyaan?: string;
    skor?: KpmrSkorDto;
    indicator?: KpmrIndicatorDto;
